		...
		if ($category_info) {
			...
			foreach ($results as $result) {
				...
				$data['categories'][] = array(
					...
					'thumb'    => $image
				// 	'img' => $this->model_tool_image->resize($category_info['image'], $this->config->get($this->config->get('config_theme') 
				// 	. '_image_category_width'), $this->config->get($this->config->get('config_theme') 
